...
function runEntryLogic(byDate, sortedDates, options = {}) {
  ...
  const reversalBreakouts = findReversalBreakouts(byDate, sortedDates, sharpMovePct, pullbackNearPct, maxGapUpPct, maxEntryCandleRangePct, maxSlPct, getPrevDayVolume, maxPullbackPct, maxConsolidationRangePct, getPrevDayCloseDaily, getDayOpenDaily, onSkip, maxEntryTime);
